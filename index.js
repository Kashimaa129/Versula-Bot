...
client.on('ready', async () => {
  ...
  console.log(`Vote This Bot in Top.gg`)
  console.log(`https://top.gg/bot/903496918888497173/vote`)
  console.log(`Vote IT :)`)
  client.user.setActivity(config.status.name, { type: config.status.type.toUpperCase(), url: "https://twitch.tv/MorenaMiyazawa" })
});
client.on("message", async(message) =>{
  ...
  if (command == prefix + `help`) {
    let embed = new Discord.MessageEmbed()
      .setTitle(`Versula Command List`)
      .setDescription(`<a:pinkdots:899638099901046824> \`${prefix}send\` - Send a message to open tickets
<a:pinkdots:899638099901046824>  \`${prefix}add\` - Adds a member to a specific ticket
<a:pinkdots:899638099901046824> \`${prefix}remove\` - Removes a member to a specific ticket.
<a:pinkdots:899638099901046824> \`${prefix}delete\` - Delete a specific ticket
<a:pinkdots:899638099901046824> \`${prefix}close\` - Close a specific ticket
<a:pinkdots:899638099901046824> \`${prefix}open\` - Open a specific ticket
<a:pinkdots:899638099901046824> \`${prefix}rename\` - Rename a ticket
<a:pinkdots:899638099901046824> \`${prefix}setchannels\` - set Category 
<a:menherspin:888255438385193002> - **Administrator**
<a:pinkdots:899638099901046824> \`${prefix}setowner\` - set owner 
<a:pinkdots:899638099901046824> \`${prefix}setchannels\` - set channels relating to ticket log and category
<a:pinkdots:899638099901046824> \`${prefix}setstaff\` - set staff roles`)
      .setTimestamp()
      .setColor(0x5865F2)
  ...
  if (command == prefix + 'send' || command == prefix + 'ticket') {
    ...
    .setEmoji('898048933434109972')
    .setValue("op")
    .setDescription('Create A Ticket If You Have question')
    ...
    .setLabel('buy bot sorce code ')
    .setEmoji('890451058307002399')
    .setValue("shop")
    .setDescription(' buy sorce code of bots ')  
 ...
 value : "<a:moderation:899638443590709248> Open Ticket If You Need Help Or Question"  
        },
   
)
.setThumbnail("https://images-ext-2.discordapp.net/external/rElwPMh_woAej7fUkis35ZmATyx1oBx1Jc9hcPogcIs/%3Fsize%3D1024/https/cdn.discordapp.com/avatars/903496918888497173/7ad1cb60adc1bd37a238a468369aa99b.png?width=205&height=205")
.setImage("https://images-ext-2.discordapp.net/external/f0BCxjHxif6F2HGqZyOYJrzvc78yWCmwuB5VdDtPhYc/%3Fwidth%3D540%26height%3D216/https/media.discordapp.net/attachments/898387150729535528/903515446907650078/standard_4.gif?width=486&height=194")
...
if (button.values[0] === "shop1") { // Admins +
  ...
  **Your ticket has been successfully opened** <#${channel.id}>`, true)
        ...
        const embedticket = new Discord.MessageEmbed()
          ...
          .setFooter(`Ticket opened at`)
          .setColor(0x5865F2)
          .setDescription(`Pls wait Owner and Co owner help you soon <:arrow:883908192638222357>Tell how much you can spend on it 
<:arrow:883908192638222357> Tell bot Name , Prefix, avatar 
If no one reply you then you can create a other ticket 
<:arrow:883908192638222357> Do not expect instant help 
<:arrow:883908192638222357> Timing 
Monday- 3pm to 9pm
Tuesday- 3pm to 9pm
...
require("http").createServer((req, res) => res.end("LernoxBot")).listen(process.env.PORT || 8080)
